    ...
    public class DataTests
    {
        ...
        public void TestResumenListaVacia()
        {
            Assert.AreEqual("<h1>Lista vacía de formas!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), Traductor.Castellano));
        }
        ...
        public void TestResumenListaVaciaFormasEnIngles()
        {
            Assert.AreEqual("<h1>Empty list of shapes!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), Traductor.Ingles));
        }
        ...
        [TestCase]
        public void TestResumenRectanguloItalianoCuadrado()
        {
            var formas = new List<FormaGeometrica>
            {
            ...
            Assert.AreEqual(
                "<h1>Rapporto sul modulo</h1>2 Rettangoli | Area 400 | Perimetro 120 <br/>1 Piazza | Area 25 | Perimetro 20 <br/>TOTAL:<br/>3 forme Perimetro 140 Area 425",
                resumen);
        }
